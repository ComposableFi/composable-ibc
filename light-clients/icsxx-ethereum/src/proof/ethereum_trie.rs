...
//
// #[cfg(feature = "std")]
// impl<'a, HO: std::fmt::Debug, CE: std::error::Error> std::fmt::Display for VerifyError<'a, HO,
// CE> { 	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
// 		match self {
...
// where
// 	L: TrieLayout,
// 	<L as trie_db::TrieLayout>::Hash: hash_db::Hasher,
// {
// 	if proof.is_empty() {
