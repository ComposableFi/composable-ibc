...
//! Definition of domain type message `MsgUpdateAnyClientProof`.
...
pub struct MsgUpdateAnyClientProof<C: ClientTypes> {
	pub client_id: ClientId,
	pub client_message: C::AnyClientMessage,
	pub signer: Signer,
}

impl<C> MsgUpdateAnyClientProof<C>
where
	C: ClientTypes,
{
	pub fn new(client_id: ClientId, client_message: C::AnyClientMessage, signer: Signer) -> Self {
		MsgUpdateAnyClientProof { client_id, client_message, signer }
	}
}

impl<C> Msg for MsgUpdateAnyClientProof<C>
where
	C: ClientTypes + Clone,
...
impl<C> Protobuf<RawMsgUpdateClient> for MsgUpdateAnyClientProof<C>
where
	C: ClientTypes + Clone,
	C::AnyClientMessage: Clone,
	Any: From<C::AnyClientMessage>,
	MsgUpdateAnyClientProof<C>: TryFrom<MsgUpdateClient>,
	<MsgUpdateAnyClientProof<C> as TryFrom<MsgUpdateClient>>::Error: Display,
{
}

impl<C> TryFrom<RawMsgUpdateClient> for MsgUpdateAnyClientProof<C>
where
	C: ClientTypes,
...
impl<C> From<MsgUpdateAnyClientProof<C>> for RawMsgUpdateClient
where
	C: ClientTypes,
	Any: From<C::AnyClientMessage>,
{
	fn from(ics_msg: MsgUpdateAnyClientProof<C>) -> Self {
		RawMsgUpdateClient {
