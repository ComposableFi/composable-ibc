...
mod sealed {
	...
	impl borsh::BorshDeserialize for ConnectionEnd {
		fn deserialize_reader<R: borsh::maybestd::io::Read>(
			...
			let result = InnerConnectionEnd::deserialize_reader(reader)?;
			...
			scale_info::Type::builder()
				...
				.composite(
					scale_info::build::Fields::named()
						...
						.field(|f| {
							f.ty::<Counterparty>().name("counterparty").type_name("Counterparty")
						})
						.field(|f| {
							f.ty::<Vec<Version>>().name("versions").type_name("Vec<Version>")
						})
