...
use super::{utils, utils::USE_GETH};
use crate::{
...
use ibc::{
	core::{
		...
		ics03_connection::msgs::conn_open_ack::MsgConnectionOpenAck,
		ics04_channel::{
			channel::Order,
...
pub async fn hyperspace_ethereum_client_fixture(
	...
	// crate::client::EthereumClient::new(
	EthereumClientConfig {
		...
		tendermint_client_address: Default::default(),
		mnemonic: None,
		max_block_weight: 1,
		private_key: wallet,
