...
pub async fn deploy_governance<M: Middleware>(
	...
	for name in [IbcTransferDiamond, IbcCoreDiamond, BankDiamond, TendermintDiamond] {
		yui_ibc
...
> {
	...
	let facet_names =
		vec![ICS20Bank, DiamondCutFacet, DiamondLoupeFacet, OwnershipFacet, GovernanceFacet];
