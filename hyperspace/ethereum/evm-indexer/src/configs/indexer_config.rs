...
#[derive(Parser, Debug)]
#[command(name = "EVM Indexer", about = "A scalable SQL indexer for EVM compatible blockchains.")]
pub struct EVMIndexerArgs {
	...
	#[arg(long, help = "Reset a chain to restart the index.", default_value_t = false)]
	pub reset: bool,

	#[arg(long, help = "Recalculate the amount of blocks indexed.", default_value_t = false)]
