...
use cumulus_pallet_parachain_system::{
	RelayNumberMonotonicallyIncreases, RelayNumberStrictlyIncreases,
};
use ibc::core::{
...
impl cumulus_pallet_parachain_system::Config for Runtime {
	...
	type DmpQueue = frame_support::traits::EnqueueWithOrigin<MessageQueue, ReservedXcmpWeight>;
...
impl orml_asset_registry::Config for Runtime {
	...
	type AssetProcessor = orml_asset_registry::SequentialId<Self>;
	type AuthorityOrigin = AsEnsureOriginWithArg<EnsureRoot<AccountId>>;
	type Balance = Balance;
	type CustomMetadata = ();
	type WeightInfo = ();
	type StringLimit = ConstU32<150>;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		AssetRegistry: orml_asset_registry = 38,
