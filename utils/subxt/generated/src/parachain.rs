...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							32u8, 20u8, 0u8, 192u8, 210u8, 124u8, 163u8, 75u8, 89u8, 65u8, 164u8,
							42u8, 241u8, 218u8, 70u8, 249u8, 117u8, 232u8, 56u8, 40u8, 227u8, 97u8,
							124u8, 99u8, 162u8, 37u8, 143u8, 203u8, 246u8, 192u8, 212u8, 38u8,
						],
					)
				}
		...
		pub mod cumulus_pallet_parachain_system {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 3)]
					#[doc = "An upgrade has been authorized."]
					UpgradeAuthorized { code_hash: ::subxt::ext::sp_core::H256 },
					#[codec(index = 4)]
					#[doc = "Some downward messages have been received and will be processed."]
		...
		pub mod cumulus_pallet_xcmp_queue {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 2)]
					#[doc = "Bad XCM version used."]
					BadVersion { message_hash: ::core::option::Option<::subxt::ext::sp_core::H256> },
					#[codec(index = 3)]
					#[doc = "Bad XCM format used."]
					BadFormat { message_hash: ::core::option::Option<::subxt::ext::sp_core::H256> },
					#[codec(index = 4)]
					#[doc = "An upward message was sent to the relay chain."]
					UpwardMessageSent {
						message_hash: ::core::option::Option<::subxt::ext::sp_core::H256>,
		...
		pub mod pallet_collator_selection {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 4)]
					CandidateRemoved { account_id: ::subxt::ext::sp_core::crypto::AccountId32 },
				}
			}
		}
		pub mod pallet_ibc {
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				188u8, 67u8, 51u8, 154u8, 113u8, 10u8, 221u8, 114u8, 224u8, 37u8, 99u8, 105u8,
				16u8, 226u8, 182u8, 229u8, 30u8, 50u8, 46u8, 115u8, 178u8, 105u8, 216u8, 121u8,
				192u8, 249u8, 185u8, 87u8, 116u8, 85u8, 138u8, 193u8,
			] {
