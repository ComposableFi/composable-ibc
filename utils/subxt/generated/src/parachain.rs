...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							244u8, 58u8, 3u8, 56u8, 183u8, 141u8, 53u8, 7u8, 32u8, 144u8, 240u8,
							121u8, 151u8, 249u8, 73u8, 150u8, 43u8, 122u8, 21u8, 113u8, 222u8,
							139u8, 90u8, 238u8, 34u8, 248u8, 93u8, 223u8, 239u8, 36u8, 190u8,
							117u8,
						],
					)
				}
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				197u8, 233u8, 193u8, 191u8, 174u8, 219u8, 89u8, 60u8, 69u8, 43u8, 133u8, 34u8,
				177u8, 159u8, 142u8, 108u8, 146u8, 153u8, 42u8, 146u8, 214u8, 8u8, 65u8, 125u8,
				209u8, 157u8, 18u8, 21u8, 150u8, 84u8, 137u8, 220u8,
			] {
