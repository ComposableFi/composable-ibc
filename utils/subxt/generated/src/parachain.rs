...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							128u8, 10u8, 7u8, 105u8, 199u8, 228u8, 10u8, 54u8, 24u8, 23u8, 147u8,
							143u8, 118u8, 118u8, 115u8, 182u8, 199u8, 42u8, 170u8, 113u8, 254u8,
							74u8, 145u8, 132u8, 184u8, 172u8, 186u8, 210u8, 76u8, 4u8, 65u8, 22u8,
						],
					)
				}
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				109u8, 178u8, 209u8, 25u8, 57u8, 237u8, 151u8, 166u8, 24u8, 53u8, 153u8, 65u8,
				86u8, 132u8, 36u8, 199u8, 171u8, 209u8, 53u8, 22u8, 68u8, 150u8, 12u8, 217u8, 37u8,
				79u8, 183u8, 20u8, 4u8, 254u8, 40u8, 44u8,
			] {
