...
pub mod api {
	...
	pub static PALLETS: [&str; 8usize] =
		["System", "Babe", "Timestamp", "Grandpa", "Paras", "Beefy", "MmrLeaf", "Sudo"];
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				254u8, 185u8, 83u8, 107u8, 111u8, 16u8, 44u8, 229u8, 157u8, 211u8, 212u8, 84u8,
				22u8, 252u8, 108u8, 151u8, 9u8, 182u8, 180u8, 151u8, 96u8, 191u8, 90u8, 22u8, 75u8,
				158u8, 253u8, 1u8, 250u8, 36u8, 193u8, 135u8,
			] {
