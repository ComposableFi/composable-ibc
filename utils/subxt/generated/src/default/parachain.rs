...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							162u8, 111u8, 153u8, 168u8, 217u8, 165u8, 7u8, 75u8, 25u8, 186u8,
							123u8, 139u8, 243u8, 95u8, 225u8, 199u8, 158u8, 199u8, 98u8, 238u8,
							48u8, 212u8, 253u8, 174u8, 79u8, 75u8, 50u8, 180u8, 212u8, 56u8, 127u8,
							212u8,
						],
					)
				}
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				112u8, 180u8, 206u8, 232u8, 146u8, 161u8, 36u8, 99u8, 100u8, 175u8, 222u8, 135u8,
				121u8, 42u8, 191u8, 220u8, 50u8, 24u8, 45u8, 183u8, 84u8, 254u8, 228u8, 17u8,
				106u8, 117u8, 44u8, 26u8, 128u8, 151u8, 193u8, 145u8,
			] {
