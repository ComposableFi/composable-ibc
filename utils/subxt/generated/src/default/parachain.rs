...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							242u8, 56u8, 215u8, 101u8, 182u8, 111u8, 0u8, 104u8, 86u8, 233u8, 17u8,
							160u8, 104u8, 237u8, 236u8, 20u8, 23u8, 25u8, 29u8, 119u8, 84u8, 55u8,
							141u8, 192u8, 230u8, 173u8, 73u8, 245u8, 226u8, 97u8, 74u8, 168u8,
						],
					)
				}
	...
	pub mod ibc {
		...
		pub mod calls {
			...
			impl TransactionApi {
				...
				pub fn increase_counters(&self) -> ::subxt::tx::StaticTxPayload<IncreaseCounters> {
					::subxt::tx::StaticTxPayload::new(
						"Ibc",
						"increase_counters",
						IncreaseCounters {},
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				75u8, 176u8, 133u8, 21u8, 157u8, 133u8, 12u8, 78u8, 80u8, 120u8, 121u8, 247u8,
				214u8, 70u8, 174u8, 151u8, 223u8, 87u8, 43u8, 5u8, 191u8, 124u8, 38u8, 232u8,
				175u8, 47u8, 230u8, 66u8, 13u8, 236u8, 166u8, 162u8,
			] {
