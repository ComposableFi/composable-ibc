...
pub mod api {
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				4u8, 209u8, 179u8, 178u8, 224u8, 155u8, 248u8, 127u8, 77u8, 14u8, 126u8, 122u8,
				113u8, 9u8, 226u8, 57u8, 201u8, 164u8, 145u8, 52u8, 248u8, 172u8, 59u8, 33u8,
				109u8, 244u8, 131u8, 103u8, 1u8, 118u8, 99u8, 191u8,
			] {
			...
			impl StorageApi {
				...
				pub fn events(
					...
					::std::vec::Vec<
						runtime_types::frame_system::EventRecord<
							runtime_types::kusama_runtime::RuntimeEvent,
							::subxt::utils::H256,
						>,
					>,
					::subxt::storage::address::Yes,
				...
				> {
					::subxt::storage::address::Address::new_static(
						...
						vec![],
						[
							238u8, 241u8, 66u8, 95u8, 39u8, 10u8, 30u8, 219u8, 181u8, 104u8, 30u8,
							170u8, 120u8, 227u8, 136u8, 249u8, 191u8, 92u8, 77u8, 127u8, 130u8,
							221u8, 20u8, 144u8, 112u8, 119u8, 15u8, 252u8, 11u8, 44u8, 68u8, 31u8,
						],
					)
				}
				pub fn event_count(
